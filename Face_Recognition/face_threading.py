...
def recognize_thread(cap, data_recognize_queue, data_final_queue, employees):
    global count
    while cap.isOpened():
        ...
        if count >= 10:
            ...
            for idx, kps in enumerate(kpss):
                ...
                info = face_model.face_compare(feet, employees)
    ...
    while cap.isOpened():
        ...
        for idx, face in enumerate(faces):
            ...
            try:
                ...
                name_display = unidecode(info['Name'].split()[-1] + ' - %.2f'%(info['Sim']))
...
class face_thread():
    def __init__(self, cap):
        ...
        self.employees = get_all_employee()
        ...
        self.recognize = Thread(target=recognize_thread, args=[self.cap, self.data_recognize_queue, self.data_final_queue, self.employees])
